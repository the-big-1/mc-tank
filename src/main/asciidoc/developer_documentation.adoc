...
|salespointframework.catalog |... |catalog.Catalog
|salespointframework.inventory ||inventory.Inventory
|salespointframework.quantity ||invnetory.Inventory
|salespointframework.SalespointSecurityConfiguration ||mctank.WebSecurityConfiguration
|springframework.boot||mctank.McTank
|springframework.ui| | all Contoller
|springframework.validation || catalog.CatalogController

|springframework.web || mctank.McTankWebConfiguration
|===
