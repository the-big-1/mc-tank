...
|0.1.9    | In Arbeit   | 6.11.2019           | Vivien      | Dialogbeschreibungen hinzugefügt
|===
...
|registrierter Kunde                 | <<Akteure, actors>>
|nicht-registrierter Kunde               | <<Akteure, actors>>
|Lager             | <<Klassen/Enumerationen, classes_enumerations>>
|Login                  | Authentifizierung des Users, nachdem er seine korrekten Anmeldedaten eingegeben hat
|Bestellung                  | <<Klassen/Enumerationen, classes_enumerations>>
...
|Role             | <<Klassen/Enumerationen, classes_enumerations>>
|McTank              | <<Aufgabenstellung, definition>>
|===
