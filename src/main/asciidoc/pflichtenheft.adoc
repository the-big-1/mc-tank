...
|ID              |
|Use Case        |
|Precondition(s) |A user is using the system
|Event           |The user presses "BluRay Katalog" in the navigation bar
|Expected Result |The user is shown an overview of all existing discs that are BluRays (9 different discs)
|===
