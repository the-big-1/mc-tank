...
|0.1.4   | In Arbeit   | 3.11.2019           | Vivien      | Akzeptanztestfälle hinzugefügt
|===
...
|ID                    |
|Anwendungsfall        |
|Voraussetzung(en)     |A user is using the system
|Ereignis              |The user presses "BluRay Katalog" in the navigation bar
|erwartetes Ergebnis   |The user is shown an overview of all existing discs that are BluRays (9 different discs)
|===
